...
OUTPUT = "/Users/kusumathatavarthi/jira_ai_chatbot_artifacts/Jira_AI_Copilot_5min_Demo_v2.pptx"
...
def add_title_slide(title, subtitle):
    ...
    style_title(slide.shapes.title, size=46)
...
add_title_slide(
    "Jira AI Copilot",
    "5-Minute Demo · Sci-Fi Inspired Theme\nReact UI → FastAPI → RAG over Jira",
)
